...
function App() {
  ...
  const marketSummary = useMemo(() => {
    ...
    return { close, high: Number(latest.high), low: Number(latest.low), change, changePercent: (change / Number(first.open)) * 100 };
  }, [candles]);
